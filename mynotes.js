$(function(){
        ...
        $.ajax({
            ...
            success: function(data){
                if(data == 'error'){
                    ...
                    $("textarea").val("");
                    //show hide elements
                    showHide(["#notePad", "#allNotes"], ["#notes", "#addNote", "#edit", "#done","#para"]);
                    $("textarea").focus();
    ...
    $("#allNotes").click(function(){
        $.ajax({
            ...
            success: function (data){
                $('#notes').html(data);
                showHide(["#addNote", "#edit", "#notes","#para"], ["#allNotes", "#notePad"]);
                clickonNote(); clickonDelete();
            },
            error: function(){
                $('#alertContent').text("There was an error with the Ajax Call. Please try again later.");
    ...
    $("#done").click(function(){
       ...
       //expand notes
        ...
        //show hide elements
        showHide(["#edit","#para"],[this, ".delete"]);
    });
    ...
    $("#edit").click(function(){
        ...
        //show hide elements
        showHide(["#done", "#para", ".delete"],[this]);
