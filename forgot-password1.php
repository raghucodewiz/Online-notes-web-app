...
$message .= "https://codewiz.offyoucode.co.uk/notex/xc/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'singhraaghavendra@gmail.com')){
